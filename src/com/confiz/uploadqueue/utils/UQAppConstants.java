...
public class UQAppConstants {


	private static final String TAG = "UQAppConstants.java";

	public static final String DOWNLOAD_PREFRANCE_KEY = "upload_queue_prafrence";
	...
	public static final String KEY_MAX_PARALLEL_DOWNLOADS = "parallel_uploads";

	public static final String KEY_MAX_QUEUE_LIMIT = "max_upload_items";
