...
public enum UQErrors {
	...
	/** The no error. */
	NO_ERROR(0), /** The uploading error. */
	...
	EXTERNAL_STORAGE_NOT_WRITABLE(
			R.string.error_msg_external_storage_write_protected),
	/** The external storage insufficient space. */
	EXTERNAL_STORAGE_INSUFFICIENT_SPACE(
			R.string.error_msg_external_storage_insufficient_space),
	/** The storage insufficient space for vault. */
	STORAGE_INSUFFICIENT_SPACE_FOR_VAULT(
			R.string.error_msg_external_storage_insufficient_space_vault),
	/** The S3_ tim e_ skew. */
	 ...
	 * @return the error
	 */
	public static UQErrors getError(int ordinal) {

		return UQErrors.values()[ordinal];
	}
};
