...
/**
 * The Class UQExternalStorageHandler.
 * 
 * @author Muhammad Arslan Anwar
 */
public class UQExternalStorageHandler {


	/** The Constant TAG. */
	private static final String TAG = "UQExternalStorageHandler";
	...
	public final static long SIZE_MB = UQExternalStorageHandler.SIZE_KB * UQExternalStorageHandler.SIZE_KB;

	/** Number of bytes in one GB = 2<sup>30</sup>. */
	public final static long SIZE_GB = UQExternalStorageHandler.SIZE_KB * UQExternalStorageHandler.SIZE_KB * UQExternalStorageHandler.SIZE_KB;
	...
	public static boolean isExternalStorageAvailable() {
		...
		try {
			...
			UQDebugHelper.printAndTrackException(UQExternalStorageHandler.TAG, exception);
		}
	...
	public static long getExternalStorageTotalSpace() {
		...
		long temp = -1L;
		try {
			UQExternalStorageHandler.stat.restat(Environment.getExternalStorageDirectory().getPath());
			temp = (long) UQExternalStorageHandler.stat.getBlockCount() * (long) UQExternalStorageHandler.stat
			        .getBlockSize();
		} catch (final Exception exception) {
			UQDebugHelper.printAndTrackException(UQExternalStorageHandler.TAG, exception);
		}
	...
	public static long getExternalStorageAvailableSpace() {
		...
		try {
			UQExternalStorageHandler.stat.restat(Environment.getExternalStorageDirectory().getPath());
			availableSpace = (long) UQExternalStorageHandler.stat.getAvailableBlocks() * (long) UQExternalStorageHandler.stat
			        .getBlockSize();
		} catch (final Exception exception) {
	...
	public static long getExternalStorageUsedSpace() {
		...
		try {
			UQExternalStorageHandler.stat.restat(Environment.getExternalStorageDirectory().getPath());
			temp = (long) (UQExternalStorageHandler.stat.getBlockCount() - UQExternalStorageHandler.stat
			        .getAvailableBlocks()) * (long) UQExternalStorageHandler.stat.getBlockSize();
		} catch (final Exception exception) {
	...
	public static long getExternalStorageBlockSize() {
		...
		try {
			UQExternalStorageHandler.stat.restat(Environment.getExternalStorageDirectory().getPath());
			temp = UQExternalStorageHandler.stat.getBlockSize();
		} catch (final Exception exception) {
	...
	public static long getExternalStorageBlockCount() {
		...
		try {
			UQExternalStorageHandler.stat.restat(Environment.getExternalStorageDirectory().getPath());
			temp = UQExternalStorageHandler.stat.getBlockCount();
		} catch (final Exception exception) {
	...
	public static long getExternalStorageAvailableBlocks() {
		...
		try {
			UQExternalStorageHandler.stat.restat(Environment.getExternalStorageDirectory().getPath());
			temp = UQExternalStorageHandler.stat.getAvailableBlocks();
		} catch (final Exception exception) {
